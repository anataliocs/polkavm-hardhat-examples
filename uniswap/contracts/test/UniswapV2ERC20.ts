...
import {ERC20} from "../../typechain-types/index";
...
describe('UniswapV2ERC20', function () {
    ...
    let token: ERC20;
    let wallet: { sendTransaction: (arg0: { to: any; value: bigint; }) => any; getAddress: () => any; address: any; };
    let other: { address: any; getAddress: () => any; };
    ...
    it('name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH', async () => {
        const deployer: any = await other.getAddress();
        ...
        const getNetwork: EthereumProvider = network.provider;
